...
# Find last row in column F (6) containing data
$xlUp = -4162
$lastRow = $escalaSheet.Cells.Item($escalaSheet.Rows.Count, 6).End($xlUp).Row
Write-Host "Last row in column F: ${lastRow}"
...
if ([System.Windows.Forms.Clipboard]::ContainsImage()) {
    ...
    $savePath = "C:\Users\opera\.gemini\antigravity\scratch\test_ademar_v2.png"
